...
| <a name="input_config_file"></a> [config\_file](#input\_config\_file) | The path to the configuration file to use | `string` | `null` | no |
| <a name="input_context"></a> [context](#input\_context) | The context to use for authentication and configuration | `string` | `null` | no |
...
| <a name="input_enable_auto_ci_support"></a> [enable\_auto\_ci\_support](#input\_enable\_auto\_ci\_support) | If automatic CI support should be enabled or not | `bool` | `null` | no |
